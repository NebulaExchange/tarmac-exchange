...
The **Nebula Trade Widget** is a React component that allows users to trade between different tokens, providing an interface to manage token exchanges.
...
```jsx
import { TradeWidgetNebula } from '@jetstreamgg/widgets';
